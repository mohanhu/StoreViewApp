...
import com.codeloop.storeviewapp.features.photo.presentation.VideoThumbNailCard
...
fun VideoListScreen(
    ...
    title: String,
    uiState: State<VideoListUiState>,
    accept : (VideoListUiAction) -> Unit,
    onBackClick: () -> Unit
) {
        ...
        Column(
            ...
            if (showSheet >= 0) {
                PreviewPagerScreen(
                    ...
                    mediaFile = uiState.value.mediaFile.filterIsInstance<VideoListUiModel.VideoList>().flatMap { it.mediaFile },
                    cancelSheetDialog = {
                        showSheet = -1
                    }
                )
                                                    ...
                                                    rowItems.forEachIndexed { columnIndex, mediaFile ->
                                                        VideoThumbNailCard(
                                                            ...
                                                            modifier = Modifier
                                                                ...
                                                                .weight(1f),
                                                            onImageClick = {
                                                                val files = uiState.value.mediaFile.filterIsInstance<VideoListUiModel.VideoList>().flatMap { it.mediaFile }
